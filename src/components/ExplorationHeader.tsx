...
const ExplorationHeader = () => {
  ...
  return <div className="relative min-h-[60vh] overflow-hidden">
      ...
      backgroundImage: `url('https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixlib=rb-4.0.3&auto=format&fit=crop&w=2071&q=80')`
    }}>
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/70 via-cyan-900/60 to-blue-900/70"></div>
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/3 w-96 h-96 bg-cyan-300/5 rounded-full blur-3xl animate-pulse delay-2000"></div>
      </div>
