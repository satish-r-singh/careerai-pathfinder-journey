      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        <div className="mb-8">
          <Button 
            ...
            className="mb-4 bg-white/20 backdrop-blur-sm border-white/30 text-purple-800 hover:bg-white/30 transition-all duration-300"
          >
            <ArrowLeft className="w-4 h-4 mr-2" />
            Back to Introspection
          </Button>
          <div className="text-center space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold gradient-text">AI Career Integration</h1>
              ...
              <CardContent className="relative z-10">
                <div className="space-y-4">
                  {roadmap.shortTermGoals?.map((goal, index) => (
                    <div key={index} className="p-4 bg-white/60 backdrop-blur-sm border border-white/20 rounded-lg shadow-md">
              ...
              <CardContent className="relative z-10">
                <ul className="space-y-3">
                  {roadmap.actionItems?.map((action, index) => (
                    <li key={index} className="flex items-start gap-3 p-3 bg-white/60 backdrop-blur-sm border border-white/20 rounded-lg shadow-sm">
